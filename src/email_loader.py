...
class EMLEmailLoader:
    ...
    def _load_eml_file(self, file_path: Path) -> Optional[Email]:
        ...
        thread_id = self._calculate_thread_id(message_id, in_reply_to, references, subject)
    ...
    def _calculate_thread_id(self, message_id: str, in_reply_to: str, 
                            references: str, subject: str) -> Optional[str]:
    ...
    def _normalize_subject(self, subject: str) -> str:
        ...
        normalized = subject
        while True:
            new_normalized = re.sub(r'^(RE|FW|FWD|Re|Fw|Fwd):\s*', '', normalized, flags=re.IGNORECASE)
...
if __name__ == "__main__":
    ...
    emails, loader = quick_test(
        emails_folder,
        output_json="../data/processed/emails_processed.json"
    )